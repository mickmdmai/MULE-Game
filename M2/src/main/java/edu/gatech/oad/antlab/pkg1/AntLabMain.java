 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Edward");
		  toPrint += p1.toString("efoyle3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Chris Blackstone");
		  toPrint += p2.toString("cblackstone7");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Laurel Goldberg");
		  toPrint += p3.toString("lgoldberg6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Mayurbhai Maisuria");
                  toPrint += p4.toString("mmaisuria3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Patrick Caruso");
                  toPrint += p5.toString("pcaruso6");
		//this is a comment by edward
